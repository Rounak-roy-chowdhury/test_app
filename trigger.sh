...
docker run -v /var/run.docker.sock:/var/run/docker.sock -v $HOME/config:/root/config -v $HOME/kubeconfig:/root/.kube -e REPO='https://github.com/MithunRosinth/demo_closet_serv' -d m1v1n/closet_start
